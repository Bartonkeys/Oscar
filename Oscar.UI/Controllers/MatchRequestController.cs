...
namespace Oscar.UI.Controllers
{
    ...
    public class MatchRequestController : ControllerBase
    {
        ...
        public MatchRequestController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        public async Task<IActionResult> PostAsync([FromForm] MatchRequestAddDto matchRequestAddDto)
        {
            var addMatchRequestCommand = new AddMatchRequestCommand
            {
                MatchRequestAddDto = matchRequestAddDto
            };
            var result = await _mediator.Send(addMatchRequestCommand);
