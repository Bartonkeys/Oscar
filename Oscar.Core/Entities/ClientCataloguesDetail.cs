...
public class ClientCataloguesDetail
{
    [IgnoreExport]
    ...
    public string? CatalogueAs400RefNum { get; set; }
    ...
    public bool FilterBy(string searchText)
    {
        return (string.IsNullOrEmpty(searchText) ||
               ...
               (!string.IsNullOrEmpty(CatalogueAs400RefNum) && CatalogueAs400RefNum.IndexOf(searchText, StringComparison.OrdinalIgnoreCase) != -1) ||
