...
{
    public class SeriesUpdateDtoValidation : AbstractValidator<SeriesUpdateDto>
	{

        public SeriesUpdateDtoValidation(OscarContext context)
		{
            ...
            When(x => x.WorksStatus != Core.Enums.WorksStatus.Uncontrolled, () =>
            {
                ...
                RuleFor(r => r.FirstBroadcastYear).GreaterThan(1900).WithMessage($"First broadcast year must greater than 1900")
