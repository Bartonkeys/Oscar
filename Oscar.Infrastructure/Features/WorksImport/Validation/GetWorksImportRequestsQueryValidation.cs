...
{
    public class GetWorksImportRequestsQueryValidation: AbstractValidator<GetWorksImportRequestsQuery>
    {
        public GetWorksImportRequestsQueryValidation()
        {
            ...
            var sortColumns = new List<string>() { "id", "status", "reference", "requestedby", "creationdate", "clientid", "catalogueid" };
    ...
    public class SearchObjectValidator : AbstractValidator<SearchObject>
    {
        public SearchObjectValidator()
        {
            ...
            var searchColumns = new List<string>() { "status", "reference", "requestedby", "clientid", "catalogueid" };
