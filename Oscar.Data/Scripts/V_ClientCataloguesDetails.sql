CREATE OR ALTER VIEW [dbo].[V_ClientCataloguesDetails] AS
 ...
 select distinct
		...
		-- Contact
		c.Title, c.FirstName as ContactFirstName, c.LastName as ContactLastName, c.Email as ContactEmail, c.JobTitle, c.Mobile as ContactMobile, 
		c.PeriodStart as ContactStartDate, c.PeriodEnd as ContactEndDate, c.Type as ContactType, c.CreationDate as ContactCreationDate, c.Website as ContactWebsite,
		-- Address
		a.AddressLine1, a.AddressLine2, a.AddressLine3, a.AddressLine4, a.Country, a.Email as AddressEmail, a.PostZipCode, a.Website, 
		-- Catalog
		ct.Id as CatalogueId, ct.Name as CatalogueName, --ct.GeneralNotes as CatalogueNotes, 
		ct.IMaestroClientCode as CatalogueAs400RefNum,
		-- Reference
		--cr.AgicoaDeclarationNumber, 
	...
	left join ContactDetails c ON c.ClientId = cl.Id and (ISNULL(c.CatalogueId, ct.Id) = ct.Id) and c.RowNum =1
